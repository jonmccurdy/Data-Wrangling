...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, colframe=quarto-callout-tip-color-frame, rightrule=.15mm, bottomrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Supplemental Material}, colbacktitle=quarto-callout-tip-color!10!white, coltitle=black, colback=white, leftrule=.75mm, breakable, opacitybacktitle=0.6, bottomtitle=1mm, left=2mm, toprule=.15mm, titlerule=0mm, toptitle=1mm, opacityback=0]
...
\pandocbounded{\includegraphics[keepaspectratio]{Lecture-4_files/figure-pdf/unnamed-chunk-10-1.pdf}}
